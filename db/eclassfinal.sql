...
|   DB   |
\______/
DATABASE UPDATED AND MERGED
ON: 03/30/2026 AT 5:00 PM
*
...
CREATE TABLE `login_tracker` (
    ...
    `last_attempt_at` bigint(20) NOT NULL,
...
CREATE TABLE `mfa_trusted_devices` (
    ...
    UNIQUE KEY `unique_device_per_user` (
        `user_id`,
        `device_fingerprint`
    )
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

/*Data for the table `mfa_trusted_devices` */
...
CREATE TABLE `student_grades` (
    ...
    KEY `idx_student_grades_released` (
        `is_released`,
        `released_date`
    ),
...
values (
        1,
        'admin001',
        'pbkdf2:sha256:600000$TZvfOSZY7KvmbJTf$a2ad3968b576e549855b4e3939db0b5964c9f3f6c8f710f74bacdd215fba6305',
        'admin',
        'active',
        '2025-12-05 22:00:46'
    );
